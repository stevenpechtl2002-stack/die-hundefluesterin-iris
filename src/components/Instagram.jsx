      ...
      <div className="max-w-7xl mx-auto px-8 md:px-16">
        ...
        <motion.div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12"
          ...
          <div>
            ...
            <h2 className="font-pacifico text-3xl md:text-5xl text-gray-900 mt-2">@hundefluesterin.iris</h2>
          </div>
          <motion.a href="https://instagram.com/hundefluesterin.iris" target="_blank" rel="noopener noreferrer"
        ...
        <motion.div className="grid grid-cols-2 md:grid-cols-3 gap-4"
          ...
          {photos.map((p, i) => (
            <motion.a key={i} variants={item}
              href="https://instagram.com/hundefluesterin.iris" target="_blank" rel="noopener noreferrer"
